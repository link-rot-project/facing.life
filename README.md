...
One major goal of this fellowship is to share the learnings with other journalists. Ideally, that will involve writing an article for a journalism trade publication. The article would make use of Brandon’s original content captured and preserved using the Starling Lab framework. This article in the journalism trade publication would be published at the same time as a case study by Brandon and Starling Lab, documenting in greater detail the process (from capture to publication of Brandon’s work), sharing learnings about the solutions and challenges along the way, and creating solutions to link rot that others can easily recreate and utilize.
